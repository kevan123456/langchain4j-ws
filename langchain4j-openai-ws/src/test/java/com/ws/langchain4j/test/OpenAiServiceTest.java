 ...
 * @since 1.0.0
 */
public class OpenAiServiceTest extends BaseTest {
    ...
    public void testWrite(){
        Writer writer = AiServices.create(Writer.class,demoModel) ;
    ...
    public void testWrite2(){
        Writer2 writer = AiServices.create(Writer2.class,demoModel) ;
