...
public class OpenAiChatTest extends BaseTest {
    ...
    StreamingChatLanguageModel demoStreamModel = OpenAiModelUtil.getDemoStreamModel() ;
    ...
    public void testDemo() {
        ...
        Response<AiMessage> response = demoModel.generate(userMessage);
        AiMessage aiMessage = response.content() ;
        System.out.println("aiMessage1:"+aiMessage.text());
        UserMessage userMessage2 = UserMessage.from("请重复一次");
        Response<AiMessage> response2 = demoModel.generate(userMessage,aiMessage,userMessage2) ;
    ...
    public void testChat() {
        ...
        try {
            response = demoModel.generate(userMessage);
        }catch (Exception e){
    ...
    public void testStreaming() throws Exception{
        demoStreamModel.generate("给我讲个笑话",new StreamingResponseHandler<AiMessage>(){
            @Override
